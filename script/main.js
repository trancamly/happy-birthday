...
const animationTimeline = () => {
  ...
  tl
    ...
    .to(".idea-14", 0.7, ideaTextTransLeave, "+=1.5")
    .from(".idea-15", 0.7, ideaTextTrans)
    .to(".idea-15", 0.7, ideaTextTransLeave, "+=1.5")
    .from(".idea-16", 0.7, ideaTextTrans)
    .to(".idea-16", 0.7, ideaTextTransLeave, "+=1.5")
    .from(".idea-17", 0.7, ideaTextTrans)
    .to(".idea-17", 0.7, ideaTextTransLeave, "+=1.5")
    .from(".idea-18", 0.7, ideaTextTrans)
    .to(".idea-18", 0.7, ideaTextTransLeave, "+=1.5")
    .from(".idea-19", 0.7, ideaTextTrans)
    .to(".idea-19", 0.7, ideaTextTransLeave, "+=1.5")
